...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM tbl_products LIMIT $start,$limit";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$pro_id    = $row['p_id'];
			//$pro_cat   = $row['product_cat'];
			//$pro_brand = $row['brands_id'];
			...
			echo "
							<div class='featured_slider_item'>
										...
										<div class='product_item d-flex flex-column align-items-center justify-content-center text-center'>
											<a href='detail.php?p=$pro_id'>
											<div class='product_image d-flex flex-column align-items-center justify-content-center'><img src='images/$pro_image' alt=''>
											</div>
											</a>
											<div class='product_content'>
												<div class='product_price'>$ $pro_price</div>
												<div class='product_name'><div><a href='detail.php?p=$pro_id'>$pro_title</a></div></div>
												<div class='product_extras'>
													...
													<button pid='$pro_id' style='float:right;' id='product' class='product_cart_button'>Add to Cart</button>
												</div>
											</div>
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.p_id,a.p_name,a.price,a.image1,b.id,b.qty FROM products a,cart b WHERE a.p_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.p_id,a.p_name,a.price,a.image1,b.id,b.qty FROM products a,cart b WHERE a.p_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
