...
<form action="<?php echo site_url();?>backend/<?php echo $c_name; ?>/save_user1/users" method="post" class="form" id="validate" enctype="multipart/form-data">
            ...
            <div id="tab1_1" class="tab-pane active">
                    ...
                    <div class="col-md-9">
                        <div class="section row ">
                            <div class="col-md-6">
                                <label for="name1" class="field prepend-icon">
                                    <input type="text" name="name1" value="<?php echo set_value('name1'); ?>" id="name1" class="event-name gui-input br-light light" placeholder="First Name" required="">
                            ...
                            <div class="col-md-6">
                                <label for="name2" class="field prepend-icon">
                                    <input type="text" name="name2" id="name2" value="<?php echo set_value('name2'); ?>" class="event-name gui-input br-light light" placeholder="Last Name" required="">
                        ...
                        <div class="section row mb15">
                            <div class="col-md-6">
                                <label for="password" class="field prepend-icon">
                                    <input type="password" name="password" id="password" class="event-name gui-input br-light light" placeholder="Password" required="">
                            ...
                            <div class="col-md-6">
                                <label for="password2" class="field prepend-icon">
                                    <input type="password2" name="password2" id="password2" class="event-name gui-input br-light light" placeholder="Confirm Password" required="">
                        ...
                        <div class="section mb15">
                            <label for="email" class="field prepend-icon">
                                <input type="text" name="email" id="email" class="event-name gui-input br-light bg-light" placeholder="Email Address" required="">
                ...
                <div class="section row">
                    <div class="col-md-6">
                        <label for="cust-phone" class="field prepend-icon">
                            <input type="text" name="tel" id="tel" class="event-name gui-input bg-light br-light" placeholder="Phone Number..." required="">
                    ...
                    <div class="col-md-6">
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="customer-group">
                                <option value="0" selected="selected">User Group...</option>
                ...
                <div class="section mb15">
                    <label class="field prepend-icon">
                        <textarea class="gui-textarea br-light bg-light" id="cust-note" name="cust-note" placeholder="Customer Notes" required=""></textarea>
                ...
                <div class="section">
                    <label for="lastaddr" class="field prepend-icon">
                        <input type="text" name="lastaddr" id="lastaddr" class="gui-input" placeholder="Street address" required="">
