                ...
                <div class="section row mbn">
                    ...
                    <div class="col-md-4 pl15">
                        ...
                        <div class="fileupload-preview thumbnail mb20" id="view_picture_1">
                           <img data-src="holder.js/100%x140" src="<?php echo base_url(); ?>upload/tours/<?php echo $tours[0]['image'];  ?>" alt="holder">
                       </div>
                                ...
                                <input type="hidden" name="image" id="image_1" value="<?php echo $tours[0]['image']; ?>" />
