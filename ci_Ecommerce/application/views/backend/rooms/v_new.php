                        ...
                        <div class="section row ">
                            <div class="col-md-6">
                                <label for="name1" class="field prepend-icon">
                                    <input type="text" name="room_code" value="" id="name1" class="event-name gui-input br-light light" placeholder="Room Code(SLG-101)" required="">
                            ...
                            <div class="col-md-6">
                                <label for="name2" class="field prepend-icon">
                                    <input type="text" name="room_title" id="name2" value="" class="event-name gui-input br-light light" placeholder="Room Name" required="">
                ...
                <div class="section row">
                    <div class="col-md-4">
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="rate_id" required>
                                <option value="0">Sellect Room Rate..</option>
                                <?php
                                foreach ($rate as $row) {
                                ?>
                    ...
                    <div class="col-md-4">
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="rt_id">
                                <option value="0">Sellect Room Type..</option>
                               <?php
                    ...
                    <div class="col-md-4">
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="position">
                                <option value="0">Sellect Positon...</option>
                                 <?php
