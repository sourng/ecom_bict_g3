...
<input type="hidden" name="id" value="<?php echo $this->m_ps->encrypt_decrypt('encrypt',$rooms[0]['room_id'])?>">
        ...
        <div class="tab-content pn br-n admin-form">
            ...
            <div id="tab1_1" class="tab-pane active">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="section row ">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="name1" class="field prepend-icon">
                                    ...
                                    <input type="text" name="room_code" value="<?php echo $rooms[0]['room_code']; ?>" id="name1" class="event-name gui-input br-light light" required="">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="name2" class="field prepend-icon">
                                    ...
                                    <input type="text" name="room_title" id="name2"  value="<?php echo $rooms[0]['room_title']; ?>" class="event-name gui-input br-light light" placeholder="Room Name" required="">
                        ...
                        <div class="section  mb15">
                            ...
                            <label for="email" class="field prepend-icon">
                                ...
                                <input type="text" name="room_slug" id="email" value="<?php echo $rooms[0]['room_slug']; ?>" class="event-name gui-input br-light bg-light" >
                    ...
                    <div class="col-md-3">
                        <div class="fileupload fileupload-new admin-form" data-provides="fileupload">
                            <div class="fileupload-preview thumbnail mb15">
                                <img src="<?php echo base_url ()?>uploads/rooms/<?php echo $rooms[0]['image']; ?>" alt="holder">
                            </div>
               ...
               <label for="customer-group" class="field select">
                            <select id="customer-group" name="rate_id">
                                <option value="0">Room Rate...</option>
                                <?php
                                    foreach ($room_rate as $row) {
                                ?>
                                <option value="<?php echo $row['rate_id'] ;?>"><?php echo $row['name'] ;?></option>
                                <?php
                                    }
                                ?>
                                <h2><?php //echo $room_rates['name'];?></h2>
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="rt_id">
                                <option value="0" disabled="true">Room Type...</option>
                            <?php
                ...
                <div class="section mb15">
                    ...
                    <label class="field prepend-icon">
                        ...
                        <textarea class="gui-textarea br-light bg-light" id="desc" name="desc" placeholder="Room Description" required=""> <?php echo $rooms[0]['desc']; ?></textarea>
            ...
            <!--<div class="section mb15">
                    ...
                    <label class="field prepend-icon">
                        ...
                        <textarea class="gui-textarea br-light bg-light" id="cust-note" name="amenities" placeholder="Room Amenities" required=""> <?php echo $rooms[0]['amenities']; ?></textarea>
                ...
                <div class="section mb15">
                    ...
                    <label class="field prepend-icon">
                        ...
                        <textarea class="gui-textarea br-light bg-light" id="include" name="include" placeholder="Room Include" required=""> <?php echo $rooms[0]['include']; ?></textarea>
                 ...
                 <div class="section mb15">
                    ...
                    <label class="field prepend-icon">
                        ...
                        <textarea class="gui-textarea br-light bg-light" id="include" name="exclude" placeholder="Room Exclude" required=""> <?php echo $rooms[0]['exclude']; ?></textarea>
                    ...
                    <div class="col-md-6">
                        <label for="customer-group" class="field select">
                            <select id="customer-group" name="position">
                                <option value="0" disabled="true">Sellect Position...</option>
                                <option value="<?php echo $position[0]['pos_id']; ?>"> <?php echo $position[0]['title']; ?></option>
                            <?php
