        ...
        margin: 0 auto;">
              ...
              if(sizeof($videos)>0){
                ...
                <tr>
					...
					<td style="width:10px;" ><?php echo $row['vid'];  ?></td>
                    <td> <img style="height: 30px; border-radius: 15%;" src="<?php echo $row['photo']; ?>"></td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo site_url();?>backend/<?php echo $c_name;?>/edit/<?php  echo $this->m_ps->encrypt_decrypt('encrypt',$row['vid'])?>" title="Edit"><img src="<?php echo base_url()?>icons/edit.png" class="tooltip-info" data-rel="tooltip" title="Edit">
