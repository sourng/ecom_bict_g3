<?php include_once ('v_login_head.php'); ?>
                ...
                <div class="row mb15 table-layout"><!--
                    <div class="col-xs-6 va-m pln">
                        <a href="#" title="Return to Dashboard">
                            <img src="<?php //echo base_url();?>backend/assets/img/logos/logo_white.png" title="AdminDesigns Logo" class="img-responsive w250">
                        </a>
                    </div>
-->
<!--                    <div class="col-xs-6 text-right va-b pr5">-->
<!--                        <div class="login-links">-->
<!--                            <a href="--><?php //site_url();?><!--lgoin" class="active" title="Sign In">Sign In</a>-->
...
<!--                    </div>-->
                ...
                <div class="panel panel-info mt10 br-n">
                    ...
                    <div class="panel-heading heading-border bg-white">
                        ...
                        <div class="ui-alerts-page">
                            <?php if($this->session->userdata('message')){ echo $this->session->userdata('message'); $this->session->set_userdata('message');}?>
                        </div>
                    </div>

                    <!-- end .form-header section -->
                    <form method="post" action="<?php echo site_url()?>backend/login/verifylogin" id="contact">
...
<!-- BEGIN: PAGE SCRIPTS -->
<?php
    include_once ('v_login_footer.php');
?>