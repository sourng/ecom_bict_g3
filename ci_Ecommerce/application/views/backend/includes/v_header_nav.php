<header class="navbar navbar-fixed-top bg-light">
    ...
    <div class="navbar-branding">
        ...
        <a class="navbar-brand" target="_blank" href="<?php echo site_url() ;?>home"><b>Dashboard</b>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="<?php echo base_url(); ?>/theme_backend/assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15">

                <span>SENG Sourng</span>
            ...
            <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                ...
                <li class="br-t of-h">
                    ...
                    <a href="<?php echo site_url(); ?>backend/login/logout" class="fw600 p12 animated animated-short fadeInDown">
