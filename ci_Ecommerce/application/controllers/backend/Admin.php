...
//            redirect(base_url() . 'index.php?admin/dashboard', 'refresh');
        ...
        $data['c_name']='backend/admin';

        $data['frm_name']  = 'Main Dashboard';
        ...
        $this->load->view('backend/desktop',$data);
    ...
    function rooms(){
        ...
        $data['body'] ='backend/rooms/v_list_rooms';
